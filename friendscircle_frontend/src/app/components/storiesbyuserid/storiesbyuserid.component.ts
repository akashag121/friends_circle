...
@Component({
  selector: 'app-storiesbyuserid',
  templateUrl: './storiesbyuserid.component.html',
  styleUrls: ['./storiesbyuserid.component.scss']
})
export class StoriesbyuseridComponent {
  ...
  ngOnInit(): void {
    ...
    this._callapi.getAllStoriesByUserId(this.userId).subscribe((d) => {
      console.log(d)
      this.AllStories = d;
      //To DO
